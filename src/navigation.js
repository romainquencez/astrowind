...
import {EMAIL, GITHUB_URL, LINKEDIN_URL, MALT_URL} from '~/utils/constants';
...
export const footerData = {
  ...
  // ],
  socialLinks: [
    { ariaLabel: 'Malt', icon: 'tabler:briefcase', href: MALT_URL },
    { ariaLabel: 'Linkedin', icon: 'tabler:brand-linkedin', href: LINKEDIN_URL },
  ...
  footNote: `
    ...
    Créé avec <a class="text-blue-600 underline dark:text-muted" href="https://onwidget.com/">onWidget</a> · Tous droits réservés.
  `,
};
